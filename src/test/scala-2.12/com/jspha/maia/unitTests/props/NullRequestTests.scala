...
object NullRequestTests {
  ...
  val workerHConsAtom: Worker[FieldType[kx.T, RequestMode.Atom[Int]] :: HNil] =
    implicitly
  val workerHConsAtom2: Worker[FieldType[ky.T, RequestMode.Atom[Int]] ::
    FieldType[kx.T, RequestMode.Atom[Int]] ::
      HNil] =
    implicitly
